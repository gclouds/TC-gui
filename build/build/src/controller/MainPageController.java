...
public class MainPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        logViewer = new TransactionLogger(this);
//        logViewer.build();
    ...
    private void fileMenuSelected(ActionEvent event) {
        ...
        System.out.println("controller.MainPageController.fileMenuSelected():" + id);
        ...
        switch (id) {
            ...
            case "file_transactionLogger":
                logViewer.build();
                BorderPane logPane = logViewer.get();
                addMainContainer(logPane);
                break;
            ...
            case "file_changeWorkSpace":
                System.out.println("controller.MainPageController.fileMenuSelected()workspacename");
                break;
    ...
    public void addMainContainer(BorderPane container) {
...
//        refreshProjectbutton.setPadding(new Insets(0, 0, 0, 0));
        ...
        toolbarMain.getItems().addAll(importProjectbutton, removeProjectButton, changeWorkSpacebutton, refreshProjectbutton);
    }
}
